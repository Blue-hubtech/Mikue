...
async def help_command(ctx, category: str = None):
    ...
    CATS = {
        "cards":      ("🎴", "Card collecting, trading & market",
                       [(".claim <captcha>","Claim a spawned card"), (".collection","Your card collection"),
                        (".cards","Browse all cards"), (".card <id>","View a card"),
                        (".deck","Your deck"), (".dupes","Duplicate cards"),
                        (".findcard <n>","Search cards"), (".cardgive @u <id>","Give a card"),
                        (".merge <id>","Merge duplicates"), (".wishlist","Your wishlist"),
                        (".market","Card market"), (".sellcard <id>","Sell a card"),
                        (".buycard <id>","Buy from market"), (".bid <id> <amt>","Bid on card"),
                        (".checkcard <id>","Check card details")]),
        "economy":    ("💫", "Stellas currency & economy",
                       [(".daily","Claim daily Stellas"), (".weekly","Weekly bonus"),
                        (".balance","Your Stellas balance"), (".give @u <amt>","Give Stellas"),
        ...
        "admin":      ("👑", "Admin & owner commands",
                       [(".addcard","Create a card"), (".editcard","Edit a card"),
                        ...
                        (".setweekly <amt>","Set weekly reward")])
    }
